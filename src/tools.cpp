...
// extern template void funcReconstruct<RSSHighType, highBit>(const RSSHighType &a, vector<highBit> &b, size_t size, string str, bool print);
// extern template void funcReconstruct<RSSLowType, lowBit>(const RSSLowType &a, vector<lowBit> &b, size_t size, string str, bool print);
